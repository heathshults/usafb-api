...
// Data Providers for the Tests to be provided within Cest Classes
    ...
    {
        return [
            ['TestCase' => 'verifyCreateSuperUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Super User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars','address'=>'12534 Street','address2'=>'Frisco'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Super User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\",\"address\": \"12534 Street\",\"address2\": \"Frisco\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }", "expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreateStakeholderUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Stakeholder User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars','address'=>'12534 Street','address2'=>'Frisco'], "expResponse" =>"{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Stakeholder User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\",\"address\": \"12534 Street\",\"address2\": \"Frisco\"}" , "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }","expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreatePartnerUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Partner User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars','address'=>'12534 Street','address2'=>'Frisco'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Partner User\" ], \"email_verified\": false, \"status\": \"Enabled\",\"country\": \"US\",\"organization\": \"Rising Stars\",\"address\": \"12534 Street\",\"address2\": \"Frisco\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }","expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreateLeague/Club/TeamUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'League/Club/Team User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars','address'=>'12534 Street','address2'=>'Frisco'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"League/Club/Team User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\",\"address\": \"12534 Street\",\"address2\": \"Frisco\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }","expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreateAdminUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Admin User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars','address'=>'12534 Street','address2'=>'Frisco'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Admin User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\",\"address\": \"12534 Street\",\"address2\": \"Frisco\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }", "expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }",'key' => 'create'],
            ['TestCase' => 'verifyCreateUserWithEmailExists', 'code' => "409", "postBodyUser" => ['first_name' => 'AutoFirst', 'last_name' => 'AutoLast', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '', 'role' => 'Super User', 'email' => 'footballautomation@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{ \"errors\":[ { \"error\": \"The email address submitted already exists in the system.\" } ] }", 'key' => 'validations'],
            ['TestCase' => 'verifyCreateUserInvalidToken', 'code' => "401", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Super User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{\"errors\":[{\"error\":\"Invalid token.\"}]}", 'key' => 'unauthorized'],
            ['TestCase' => 'verifyCreateUserNoPermission', 'code' => "403", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Super User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{\"errors\":[{\"error\":\"Permission denied.\"}]}", 'key' => 'noaccess'],
            ['TestCase' => 'verifyCreateUserNoPermissionAdminUser', 'code' => "403", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Super User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{\"errors\":[{\"error\":\"Permission denied.\"}]}", 'key' => 'adminrole']
        ];
    }
