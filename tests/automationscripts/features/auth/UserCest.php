...
// Data Providers for the Tests to be provided within Cest Classes
    ...
    {
        return [
            ['TestCase' => 'verifyCreateSuperUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Super User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Super User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }", "expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreateStakeholderUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Stakeholder User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" =>"{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Stakeholder User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\"}" , "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }","expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreatePartnerUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Partner User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Partner User\" ], \"email_verified\": false, \"status\": \"Enabled\",\"country\": \"US\",\"organization\": \"Rising Stars\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }","expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreateLeague/Club/TeamUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'League/Club/Team User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"League/Club/Team User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }","expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }", 'key' => 'create'],
            ['TestCase' => 'verifyCreateAdminUser', 'code' => "200", "errorResponseCode" => "404", "postBodyUser" => ['first_name' => 'AutoFirst-seq', 'last_name' => 'AutoLast-seq', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '75034', 'role' => 'Admin User', 'email' => 'autouser-seq@gmail.com', 'phone_number' => '1234567890','country'=>'US','organization'=>'Rising Stars'], "expResponse" => "{ \"id\": \"userID\", \"email\": \"autouser-seq@gmail.com\", \"first_name\": \"AutoFirst-seq\", \"last_name\": \"AutoLast-seq\", \"phone_number\": \"1234567890\", \"city\": \"Frisco\", \"state\": \"TX\", \"postal_code\": \"75034\", \"roles\": [ \"Admin User\" ], \"email_verified\": false, \"status\": \"Enabled\" ,\"country\": \"US\",\"organization\": \"Rising Stars\"}", "errorResponse" => "{ \"errors\":[ { \"error\": \"The user does not exist.\" } ] }", "expUserLogsResponse"=>"{ \"data\": [ { \"old_value\": null, \"new_value\": null, \"user\": \"autouserid\", \"data_field\": null, \"created_by\": \"FOOTBALL USAFB\", \"action\": \"CREATE\" } ] }",'key' => 'create'],
