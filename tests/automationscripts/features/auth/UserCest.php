...
class UserCest
{
    ...
    {
        return [
            ['TestCase' => 'verifyUserProfile', 'code' => "200", "postBody" => ['email' => 'autouser@gmail.com', 'password' => 'password123'], "expResponse" => "{ \"name\": \"autouser autouser\", \"nickname\": \"autouser\", \"email\": \"autouser@gmail.com\", \"email_verified\": true, \"http://soccer.com/metadata\": { \"firstName\": \"autouser\", \"lastName\": \"autouser\", \"roles\": [ 1, 3 ] } }", 'key' => 'authorized'],
