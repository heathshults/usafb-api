...
// Data Providers for the Tests to be provided within Cest Classes
    ...
    protected function createUser()
    {
        return [
            ...
            ['TestCase' => 'verifyCreateUserWithEmailExists(USSF Staff)', 'code' => "409", "postBodyUser" => ['first_name' => 'AutoFirst', 'last_name' => 'AutoLast', 'city' => 'Frisco', 'state' => 'TX', 'postal_code' => '', 'role' => '1', 'email' => 'autouser@gmail.com', 'phone_number' => '1234567890'], "expResponse" => "{ \"errors\":[ { \"error\": \"The email address submitted already exists in the system.\" } ] }", 'key' => 'validations'],
