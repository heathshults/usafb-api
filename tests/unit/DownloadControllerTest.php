...
class DownloadControllerTest extends \TestCase
{
    ...
    const PLAYERS_CSV = "# Years in Sport,Address,Address line 2,Birth Certificate,Cell Phone,City,Country,Current Grade,Date of Birth,Email,First Name,Game Type,Gender,Height,High School Grad Year,Instagram handle,Last Name,League,Level,Middle Name,Organization,Org State,Other Sports Played,Parent / Guardian 1 Cell Phone,Parent / Guardian 1 Email,Parent / Guardian 1 First Name,Parent / Guardian 1 Home Phone,Parent / Guardian 1 Last Name,Parent / Guardian 1 Work Phone,Parent / Guardian 2 Cell Phone,Parent / Guardian 2 Email,Parent / Guardian 2 First Name,Parent / Guardian 2 Home Phone,Parent / Guardian 2 Last Name,Parent / Guardian 2 Work Phone,Photo,SalesForce ID,USSF_ID,Position,Profile Last Updated,School Attending,School District,School State,Season,State,Team,Team Grade,Team Gender,Team Age Group,Twitter Handle,USAFB Right to Market,Weight,Zip
    ...
    const COACHES_CSV = "# of Years Coaching,Address,Address line 2,Cell Phone,City,Country,Date of Birth,Email,First Name,Game Type,Gender,Last Name,League,Level,Middle Name,Organization,Org State,SalesForce ID,USSF_ID,School,School District,School State,Season,State,Team,Team Gender,USAFB Right to Market,Zip,Certifications,Coach Role
    ...
    */
    ...
    /**
    * Should test file player was downloaded successfuly
    */
    public function testSuccessfulDownloadPlayerCsv()
    {
        $structure = [
            'csv' => [
    ...
    /**
    * Should test file coach was downloaded successfuly
    */
    public function testSuccessfulDownloadCoachCsv()
    {
        $structure = [
            'csv' => [
