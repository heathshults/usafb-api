...
class CreateStagePlayerRegEvents extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql-dw')->create('stg_player_reg_events', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::connection('mysql-dw')->drop('stg_player_reg_events');
    }
}
