...
class CreateCubePlayerRegistrations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql-dw')->create('cube_player_registrations', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->integer('dim_player_id')->unsigned();
            ...
            $table->foreign('dim_player_id')
                  ->references('id')->on('dim_players');            
    ...
    {
        Schema::connection('mysql-dw')->drop('cube_player_registrations');
    }
}
